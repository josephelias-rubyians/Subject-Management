  ...
  let(:headers) do
    ...
    describe "GET /users as admin" do
	  ...
	  describe "Admin can edit his profile" do
    	before do
	    	patch "/users/#{admin.id}", params: {firstname: 'Joseph', lastname: 'Elias'}.to_json, headers: headers
	    end
	  ...
	  describe "Admin can edit other profiles" do
    	before do
	    	patch "/users/#{teacher.id}", params: {firstname: 'Teacher', lastname: 'Tested'}.to_json, headers: headers
	    end
	  ...
	  describe "Admin can change his password" do
    	before do
	    	post change_password_admin, params: {"user": { "password": "password_new", "password_confirmation": "password_new", "current_password": "#{admin.password}" } }.to_json, headers: headers
	    end
	  ...
	  describe "Password should contain minimum 6 characters" do
    	before do
	    	post change_password_admin, params: {"user": { "password": "pass", "password_confirmation": "pass", "current_password": "#{admin.password}" } }.to_json, headers: headers
	    end
  ...
  describe "when a teacher user is logged in" do
    ...
    describe "GET /users as teacher" do
	  ...
	  describe "Teacher can edit his profile" do
    	before do
	    	patch "/users/#{teacher.id}", params: {firstname: 'Joseph', lastname: 'Elias'}.to_json, headers: headers
	    end
	  ...
	  describe "Teacher cannot edit other profiles" do
    	before do
	    	patch "/users/#{admin.id}", params: {firstname: 'Admin', lastname: 'Tested'}.to_json, headers: headers
	    end
	  ...
	  describe "Teacher can change his password" do
    	before do
	    	post change_password_teacher, params: {"user": { "password": "password_new", "password_confirmation": "password_new", "current_password": "#{teacher.password}" } }.to_json, headers: headers
	    end
	  ...
	  describe "New password and confirm password should match" do
    	before do
	    	post change_password_teacher, params: {"user": { "password": "pass", "password_confirmation": "password", "current_password": "#{teacher.password}" } }.to_json, headers: headers
	    end
